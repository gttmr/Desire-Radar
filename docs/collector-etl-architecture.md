...
| `hackernews` | public API pull | bucket/comment enrichment drift | quality contract + readiness |
| `polymarket_markets` | public API pull | market schema/availability drift | quality contract + readiness |
...
이렇게 두면 source payload 문제와 semantic candidate 문제를 분리해서 볼 수 있다.
